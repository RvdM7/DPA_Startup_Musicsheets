...
namespace DPA_Musicsheets.Helpers
{
            ...
            for (int i = 0; i < WPFStaffs.Count; i++)
            {
                ...
                switch (musicalSymbol.Type)
                {
                    case MusicalSymbolType.Note:
                        ...
                        double relationToQuartNote = beat / 4.0;
                        double percentageOfBeatNote = (1.0 / beat) / absoluteLength;
                    ...
                    case MusicalSymbolType.TimeSignature:
                        ...
                        timeSignature[0] = (byte)beatBar;
                        timeSignature[1] = (byte)(Math.Log(beat) / Math.Log(2));
